...
/**
 * Class used for static access to email communication. Main goal of this class to reduce
 * boilerplate code as much as possible and just write email messages on the fly.
 *
