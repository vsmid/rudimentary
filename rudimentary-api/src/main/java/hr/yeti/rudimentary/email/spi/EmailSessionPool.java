 ...
 *
 * Since this abstract class inherently extends {@link Instance} it means it is loaded automatically via
 ...
 *
 * By extending this class you basically provide a way to send emails. An example of one such implementation can be seen
 * in
