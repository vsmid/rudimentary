...
/**
 * Basic pool configuration class mandatory for any pool. These properties should be available to
 * the application via {@link Config} but it is not mandatory. To see how these properties are being
 * used by the framework itself using {@link Config}, take a look at the
