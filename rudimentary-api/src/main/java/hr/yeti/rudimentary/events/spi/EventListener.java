...
/**
 * Since this interface inherently extends {@link Instance} it means it is loaded automatically via {@link ServiceLoader} on application startup.
 *
 * You can have as many different EventListener implementations as you want and you can register them in
