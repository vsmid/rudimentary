 ...
 * <p>
 * Notable usages of this validator are
 ...
 * and {@link Model#constraints()}. Even though Validator usage it is not visible in the above classes it is used
 * internally by the module <b>rudimentary/rudimentary-server</b> during HTTP request processing.
 *
 * @see Constraint
 *
