...
security.realm=none # Realm name, decides which IdentityStore is to be activated. Rudimentary offers only embedded realm for now. Current values allowed are: none, embedded
