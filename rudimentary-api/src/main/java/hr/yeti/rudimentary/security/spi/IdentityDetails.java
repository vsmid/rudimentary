...
/**
 * SPI which should retrieve user details in a customized way. Common usage would be as a part of
 * {@link IdentityStore}.
 *
 ...
 * implementation of {@link IdentityStore} and the possible usage of IdentityDetails.
 *
...
public interface IdentityDetails<D> extends Instance {
  ...
  /**
   * Sets how user details are retrieved. The result should later be available via
   * {@link Identity#getDetails()}.
   *
