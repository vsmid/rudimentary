...
public class HttpEndpointTest {
    ...
    public void test_onException_method() {
        ...
        when:   exceptionInfo = okEndpoint.onException(new RuntimeException());

        then:   assertEquals(500, exceptionInfo.getHttpStatus());
    ...
    public void test_responseHttpHeaders_method() {
        expect: assertNotNull(okEndpoint.responseHttpHeaders(null));
    ...
    public void test_httpMethod_method() {
        expect: assertEquals(HttpMethod.GET, okEndpoint.httpMethod());
    }

    @Test
    @DisplayName("Default logger should return an instance of System.Logger")
    public void test_logger_method() {
        expect: assertTrue(okEndpoint.logger() instanceof System.Logger);
    }
