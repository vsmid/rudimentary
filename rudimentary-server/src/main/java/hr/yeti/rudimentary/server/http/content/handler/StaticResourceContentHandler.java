...
public class StaticResourceContentHandler implements ContentHandler<StaticResource> {
    ...
    @Override
    public StaticResource read(HttpExchange httpExchange) throws IOException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public void write(int httpStatus, StaticResource data, HttpExchange httpExchange) throws IOException {
        try (httpExchange) {
